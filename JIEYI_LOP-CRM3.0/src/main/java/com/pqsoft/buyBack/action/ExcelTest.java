...
public class ExcelTest extends Reply {

	private Map<String, Object> m;
	private String fileName;
	//private File file;

	public ExcelTest(Map<String, Object> param) {
		this.m = param;
...
//		}
	...
	public void exec() {
		...
		try {
			...
			try {
				PoiExcelUtil.excelTemplateExcle(UTIL.RES.getResource("classpath:file/"+PATH).getInputStream(), os, m);
			} catch (Exception e) {
				e.printStackTrace();
