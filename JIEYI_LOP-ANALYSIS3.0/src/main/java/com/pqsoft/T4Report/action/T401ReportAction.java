...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T401营业月报租赁物
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T401ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"租赁物类型", "区域",	"厂商",	"期初在租",	"本月起租",	"当期结清",	"当期回购",	"在租台量",	"当月融资租赁额",	"累计融资租赁额",	"当月租赁物金额",	"累计租赁物金额",	"当月首付",	"当月租金",	"当月违约金",	"当月收款总计",	"累计收款",	"当月放款",	"累计放款",	"逾期台量",	"逾期台量%",	"逾期租金",	"租金余额",	"逾期租金%"};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T401营业月报租赁物", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T4Report/T401Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T401营业月报租赁物", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T401");
//		return new ReplyAjaxPage(service.getTableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T401营业月报租赁物", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T401");
//		
//		new POIExcelUtil().expExcel2007(m,"T401营业月报租赁物.xlsx", "T401营业月报租赁物", titleName , titleIndex, service.getTableDataForExp(m));
//
//		return null;
//	}
//
