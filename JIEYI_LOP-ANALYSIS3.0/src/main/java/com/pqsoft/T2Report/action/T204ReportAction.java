...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T204A转B管理
// * </p>
// * <p>
// * Description: T204A转B管理
// * </p>
// * <p>
// * Company: 平强软件
// * </p>
...
// * @version 1.0
// */
//public class T204ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	private Map<String,Object> m = null;
//	
//	private String[] titlesName = new String[]{"区域",	"供应商",	"项目编号",	"老客户",	"新客户",	"新户属性",	"租赁物类型",	"厂商",	"机型",	"出厂编号",	"起租确认日期",	"租赁期限",	"租金总额",	"留购价款",	"已还期数",	"A客户还款期数",	"已还租金",	"违约金合计",	"实收违约金",	"剩余期数",	"剩余租金",	"变更日期",	"变更日期租金总额",	"租赁到期日期"};
//	private  String COLUMN_VIEW="COLUMN2,COLUMN3,COLUMN4,COLUMN22,COLUMN22";
...
//	private  int[] titleForm=new  int[]{13,14,17,18,19,21,23};
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T204A转B管理", "列表页面" })
...
//		return new ReplyHtml(VM.html("T2Report/T204Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T204A转B管理", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//	@aPermission(name = { "数据统计", "T204A转B管理", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		service.getOrderStatement(ORDER,m);
//				
//		new POIExcelUtil().expExcel2007(m,"T204A转B管理"+"_"+DateUtil.getSysDate()+"_"+Math.abs(new Random(100).nextInt())+".xlsx", "T204A转B管理", titleName , titleIndex, service.getTableExplorData(m));
////		new ExplorTxt().expTxt("T204A转B管理"+"_"+DateUtil.getSysDate()+"_"+Math.abs(new Random(100).nextInt())+".txt", titleName, titleIndex, service.getTableExplorData(m));
//		return null;
//	}
//
//}
