...
public class ReportAction extends Action {
	...
	@aPermission(name = { "报表管理", "流程统计", "正常流程统计" })
	...
	public Reply execute() {
		...
		param.put("HSYCZC", service.getYchs());
		context.put("chartReport", utilChart.to_chartPie(param, "报表-流程-统计状态", "流程统计", "bpm.report.getTj", "1"));
		return new ReplyHtml(VM.html(_PATH + "report_t1_chart.vm", context));
	}
	...
	public Reply t1() {
		...
		return new ReplyHtml(VM.html(_PATH + "report_t1.vm", context));
	}
