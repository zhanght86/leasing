...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T3016历史节点逾期管理
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T3016ReportAction extends Action {
...
//	@aPermission(name = { "数据统计", "T3016历史节点逾期管理", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T3Report/T3016Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3016历史节点逾期管理", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T3016");
//		return new ReplyAjaxPage(service.getTableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3016历史节点逾期管理", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T3016");
//		
//		new POIExcelUtil().expExcel2007(m,"T3016历史节点逾期管理.xlsx", "T3016历史节点逾期管理", titleName , titleIndex, service.getTableDataForExp(m));
//
//		return null;
//	}
//
