...
// * @version 1.0
// */
//public class T3121ReportAction extends Action{
//	
...
//	@aPermission(name = {"数据统计", "T3121到期应收租金逾期率"})
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
//	public Reply execute() {
//		VelocityContext context = new VelocityContext();
//		
//		return new ReplyHtml(VM.html("/T31Report/T312/T3121Parent.vm", context));
//	}
//	
//	@aAuth(type = aAuth.aAuthType.LOGIN)
//	@aPermission(name = {"数据统计", "T3121到期应收租金逾期率"})
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
//	public void getT3121Chart(){
...
//		// 统计类型
//		map.put("CREDIT_TYPE", "201");
//		
//		String xmlStr = service.getChanPinXml(map);
//		if(xmlStr.length() > 0){
