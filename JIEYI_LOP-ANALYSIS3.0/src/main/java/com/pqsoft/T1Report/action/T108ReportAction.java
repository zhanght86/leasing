...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T108供应商租金回款
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T108ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"区域",	"供应商",	"厂商",	"本月新增应收",	"逾期应收",	"本月新增实收",	"逾期实收",	"本月新增回款率",	"逾期回款率",	"本月新增承租人实收",	"逾期承租人实收",	"本月新增承租人占比",	"逾期承租人占比",	"本月新增非承租人实收",	"逾期非承租人实收",	"本月新增非承租人占比",	"逾期非承租人占比","承租人还款率"};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T108供应商租金回款", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T1Report/T108Report.vm", context));
//	}
//	
//
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T108供应商租金回款", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
//	public Reply updateTableData(){
//		service.insertT108TableData();
//		return new ReplyAjax(true,null,null);
//	}
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T108");
//		return new ReplyAjaxPage(service.getT108TableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T108供应商租金回款", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T108");
//		
//		new POIExcelUtil().expExcel2007(m,"T108供应商租金回款.xlsx", "T108供应商租金回款", titleName , titleIndex, service.getT108TableDataForExp(m));
//
//		return null;
//	}
//
