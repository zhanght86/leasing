...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T105风险债权统计
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T105ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"编号",	"厂商名称",	"当前在租总台量",	"当前留购总台量",	"当前回购总台量",	"债权明细统计"};
//	private  String COLUMN_VIEW="COLUMN2,ID";
//	private  String COLUMN_FORM="PARAM1,COM_TYPE";
//	private  String COLUMN_RELATION="LIKE,EQ";
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T105风险债权统计", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T1Report/T105Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T105风险债权统计", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T105风险债权统计", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//
//		new POIExcelUtil().expExcel2007(m,"T105风险债权统计.xlsx", "T105风险债权统计", titleName , titleIndex, service.getTableExplorData(m));
//
//		return null;
//	}
//
