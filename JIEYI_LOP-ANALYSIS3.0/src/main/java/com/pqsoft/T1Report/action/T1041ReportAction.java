...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T1041未来租金统计
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T1041ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"月度",	"租金余额",	"本金余额",	"利息余额",	"计划回收租金",	"计划回收本金",	"计划回收利息",	"预收留购价款"};
//	private  int[] titleForm=new  int[]{2,3,4,5,6,7,8};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T1041未来租金统计", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T1Report/T1041Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T1041未来租金统计", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
////		}
//		m.put("V_NAME", "V_REPORT_T1041");
//		m.put("titleForm", titleForm);
//		return new ReplyAjaxPage(service.getTableT1041DataPage(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T1041未来租金统计", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T1041");
//		
//		new POIExcelUtil().expExcel2007(m,"T1041未来租金统计.xlsx", "T1041未来租金统计", titleName , titleIndex, service.getTableExplorData(m));
//
//		return null;
//	}
//
