...
import com.pqsoft.capitalPool.supplierPool.service.SupPadSinkPoolService;
...
public class SupPadSinkPoolAction extends Action {

	private String path = "capitalPool/supplierPool/";
	private SupPadSinkPoolService service = new SupPadSinkPoolService();
	
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","主管理页面"})
	...
	public Reply execute() {
		...
		return new ReplyHtml(VM.html(path+"supPadSinkMain.vm", context));
	}
	
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","可用余额管理-列表"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	public Reply showBalancePage(){
		Map<String,Object> param = _getParameters();
		VelocityContext context = new VelocityContext();
		context.put("param", param);
		return new ReplyHtml(VM.html(path+"supPadSinkBalancePage.vm", context));
	}
	
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","可用余额管理-查询"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	public Reply getPageData(){
		Map<String,Object> param = _getParameters();
		Page pagedata = service.getPageDataCanUse(param);
		return new ReplyAjaxPage(pagedata);
	}
	
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","余额细项下拉列表"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	public Reply getPadSinkList(){
		Map<String,Object> param = _getParameters();
		List<Object> bailList = service.getPadSinkList(param);
		return new ReplyJson(JSONArray.fromObject(bailList));
	}
	
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","退款管理-列表"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	public Reply showPadSinkRefundPage(){
		Map<String,Object> param = _getParameters();
		VelocityContext context = new VelocityContext();
		context.put("param", param);
		return new ReplyHtml(VM.html(path+"supPadSinkRefundPage.vm", context));
	}
	
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","退款管理-查询"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	...
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","余款冲抵管理-列表"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	public Reply showOffsetPage(){
		Map<String,Object> param = _getParameters();
		VelocityContext context = new VelocityContext();
		context.put("param", param);
		return new ReplyHtml(VM.html(path+"supPadSinkOffsetPage.vm", context));
	}
	
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","余款冲抵管理-查询"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	public Reply getOffsetPageData(){
		Map<String,Object> param = _getParameters();
	...
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","保存退款单"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	...
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","资金解冻/资金冻结"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	...
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","[退款]移除退款单部分款项"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	...
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","[退款]删除退款单"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
	...
	@aAuth(type = aAuth.aAuthType.USER)
	@aPermission(name ={"资金管理","供应商余款池管理","供应商余款发起退款流程"})
	@aDev(code = "170016", email = "jinhondon@126.com", name = "靳洪东")
