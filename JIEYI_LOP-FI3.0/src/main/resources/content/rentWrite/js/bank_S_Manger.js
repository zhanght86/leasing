$(document).ready(function(){
	...
	$("#pageTable").datagrid({
		...
		fitColumns:true,
		toolbar:'#pageForm',
		url:'rentWrite!toAjaxData.action',
		columns:[[
				...
				onExpandRow : function(index, row) {
					jQuery.ajax({
						url:_basePath+"/rentWrite/rentWrite!getFundDetailData.action?HEAD_ID="+row.HEAD_ID,  
						type:'post',
						dataType:'json',
...
function exportData(flag){
	...
	var url="rentWrite!HEAD_Upload.action?IDS="+IDS+"&HEAD_ID="+HEAD_ID+"&FI_PAY_MONEY="+FI_PAY_MONEY+"&FI_PAY_DATE1="+FI_PAY_DATE1+"&FI_PAY_DATE2="+FI_PAY_DATE2+"&FI_STATUS="+FI_STATUS+"&type="+type;
