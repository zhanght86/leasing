...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T2032项目回购
// * </p>
// * <p>
// * Description: T2032项目回购
// * </p>
// * <p>
// * Company: 平强软件
// * </p>
...
// * @version 1.0
// */
//public class T2032ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	private Map<String,Object> m = null;
//	
//	private String[] titlesName = new String[]{"区域",	"供应商",	"还款计划编号",	"客户名称",	"租赁物类型",	"厂商",	"机型",	"出厂编号",	"台量",	"起租确认日期",	"租赁期限",	"租金总额",	"留购价款",	"是否第三方回购",	"实际回购方",	"预约回购日期",	"已还期数",	"已还租金",	"剩余期数",	"剩余租金",	"逾期期数",	"逾期租金",	"逾期天数",	"违约金",	"回购违约金",		"减免利息",	"保证金",	"担保费",	"税金",	"其他应收款",	"回购价格合计", "到帐日期"};
//	private  String COLUMN_VIEW="COLUMN2,COLUMN3,COLUMN4,COLUMN16,COLUMN16";
...
//	@aPermission(name = { "数据统计", "T2032项目回购", "列表页面" })
...
//		return new ReplyHtml(VM.html("T2Report/T2032Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T2032项目回购", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//	@aPermission(name = { "数据统计", "T2032项目回购", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		service.getOrderStatement(ORDER,m);
//				
//		new POIExcelUtil().expExcel2007(m,"T2032项目回购"+"_"+DateUtil.getSysDate()+"_"+Math.abs(new Random(100).nextInt())+".xlsx", "T2032项目回购", titleName , titleIndex, service.getTableExplorData(m));
////		new ExplorTxt().expTxt("T2032项目回购"+"_"+DateUtil.getSysDate()+"_"+Math.abs(new Random(100).nextInt())+".txt", titleName, titleIndex, service.getTableExplorData(m));
//		return null;
//	}
//
//}
