...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T403营业月报-厂商
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T403ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"编号",	"厂商名称",	"当前在租总台量",	"当前留购总台量",	"当前回购总台量",	"明细统计"};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T403营业月报-厂商", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T4Report/T403Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T403营业月报-厂商", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T403");
//		return new ReplyAjaxPage(service.getTableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T403营业月报-厂商", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T403");
//		
//		new POIExcelUtil().expExcel2007(m,"T403营业月报-厂商.xlsx", "T403营业月报-厂商", titleName , titleIndex, service.getTableDataForExp(m));
//
//		return null;
//	}
//
