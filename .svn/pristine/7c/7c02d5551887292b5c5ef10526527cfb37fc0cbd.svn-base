...
import com.pqsoft.base.suppliersInfo.service.AssetsDossierService;
...
public class AssetsDossierAction extends Action {
	...
	String path = "base/suppMainRelation/assetsDossier/";

	@aPermission(name = { "合作机构", "渠道管理", "查看", "资产档案" })
	...
	@aPermission(name = { "合作机构", "渠道管理", "修改", "资产档案" })
	@aAuth(type = aAuthType.USER)
	@aDev(code = "170026", email = "whlpqsoft@163.com", name = "王海龙")
	...
	public Reply executeShow() {
		...
		VelocityContext context = new VelocityContext();
		context.put("param", param);
		return new ReplyHtml(VM.html(path + "assetsDossierMgDetail.vm", context));
	}
	...
	public Reply toMgEquipment() {
		...
		VelocityContext context = new VelocityContext();
		String TYPE = "设备类型";
		List<Object> list = (List<Object>) new DataDictionaryMemcached().get(TYPE);
	...
	@aAuth(type = aAuth.aAuthType.LOGIN)
	@aDev(code = "180004", email = "tao_yan_min@163.com", name = "陶言民")
	public Reply toMgEquipmentDetail() {
		Map<String, Object> param = _getParameters();
		VelocityContext context = new VelocityContext();
		String TYPE = "设备类型";
		List<Object> list = (List<Object>) new DataDictionaryMemcached().get(TYPE);
		context.put("equipmentTypeList", list);
		context.put("param", param);
		return new ReplyHtml(VM.html(path + "equipmentMgDetail.vm", context));
	}
	...
	@aAuth(type = aAuth.aAuthType.LOGIN)
	@aDev(code = "180004", email = "tao_yan_min@163.com", name = "陶言民")
	public Reply toMgHouseDetail() {
		Map<String, Object> param = _getParameters();
		VelocityContext context = new VelocityContext();
		context.put("param", param);
		return new ReplyHtml(VM.html(path + "houseMgDetail.vm", context));
	}
	 ...
	 * @return
	 * @author: 陶言民
	 * @date: 2015-9-02 下午12:10:38
	 */
	@aAuth(type = aAuth.aAuthType.LOGIN)
	@aDev(code = "180004", email = "tao_yan_min@163.com", name = "陶言民")
	public Reply toMgEstateDetail() {
		Map<String, Object> param = _getParameters();
		VelocityContext context = new VelocityContext();
		context.put("param", param);
		return new ReplyHtml(VM.html(path + "estateMgDetail.vm", context));
	}
	...
	public Reply toMgOtherDetail() {
		...
		context.put("otherAssetsTypeList", list);
		context.put("param", param);
		return new ReplyHtml(VM.html(path + "otherMgDetail.vm", context));
	}
