...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T3012逾期金额统计
// * </p>
// * <p>
// * Description:  T3012逾期金额统计
// * </p>
// * <p>
// * Company: 平强软件
// * </p>
...
// * @version 1.0
// */
//public class T3012ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"区域",	"供应商",	"厂商",	"租金余额",	"逾期租金余额",	"逾期余额%",	"逾1期余额",	"逾2期余额",	"逾3期余额",	"超3期余额",	"逾期租金金额",	"逾期金额%",	"逾1期金额",	"逾2期金额",	"逾3期金额",	"超3期金额"};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3012逾期金额统计", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T3Report/T3012Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3012逾期金额统计", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//			m.put("SUP_TYPE", map.get("SUP_ID"));
//			System.out.println("wjd---------"+map.get("SUP_ID"));
//		}
//		
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T3012");
//		return new ReplyAjaxPage(service.getTableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3012逾期金额统计", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T3012");
//		
//		new POIExcelUtil().expExcel2007(m,"T3012逾期金额统计.xlsx", "T3012逾期金额统计", titleName , titleIndex, service.getTableDataForExp(m));
//
//		return null;
//	}
//
