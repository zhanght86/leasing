$(function(){
	$("#table1").datagrid({
		url : 'FinanceModify!goClientPage.action',
		columns : [[
			{field:'CLIENTID',align:'center',width:100,title: '操作',formatter:function(value,rowData,rowIndex){
			...
			{field:'PROVE_ID',title:'财务接口编号(社会)',width:100,align:'center'},
...
$(document).ready(function(){
    ...
    $("#save").click(function(){
        ...
        if(prov_id=='' && prov_split_id=='')
        {
            ...
            jQuery.ajax({
             	url:  "FinanceModify!modifyClientPage.action",
             	data: "ID="+client_id+"&PROV_ID="+prov_id+"&PROV_SPLIT_ID="+prov_split_id,
             	type: "post",
     			dataType:"json",
...
function exportExcel(flag){
	...
	//url
	var url = 'FinanceModify!explorExcleClient.action';
	if(flag == 'all')
	{
		url += "?exportAll=true";
	}else
