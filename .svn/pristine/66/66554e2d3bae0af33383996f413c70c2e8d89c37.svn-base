...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T402营业月报-供应商
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T402ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"厂商",	"区域",	"供应商",	"期初在租",	"本月起租",	"当期结清",	"当期回购",	"在租台量",	"当月融资租赁额",	"累计融资租赁额",	"当月租赁物购买价款",	"累计租赁物购买价款",	"当月首付",	"当月租金",	"当月违约金",	"当月收款总计",	"累计收款总计",	"当月放款",	"累计放款",	"逾期台量",	"逾期台量%",	"逾期租金",	"租金余额",	"逾期租金%"};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T402营业月报-供应商", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T4Report/T402Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T402营业月报-供应商", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T402");
//		return new ReplyAjaxPage(service.getTableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T402营业月报-供应商", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T402");
//		
//		new POIExcelUtil().expExcel2007(m,"T402营业月报-供应商.xlsx", "T402营业月报-供应商", titleName , titleIndex, service.getTableDataForExp(m));
//
//		return null;
//	}
//
