...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T3014逾期超级管理
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T3014ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"区域",	"供应商",	"厂商",	"月初在租",	"起租台量",	"起租撤销",	"放款台量",	"留购台量",	"提前还租",	"回购台量",	"在租台量",	"逾期台量",	"台量逾%",	"逾1台量",	"逾2台量",	"逾3台量",	"3期以上",	"融资租赁额",	"租金总额",	"应放款",	"实放款",	"实收首期付款",	"月初租金余额",	"本月回收租金",	"累计回收租金",	"租金余额",	"逾期租金余额",	"逾期余额%",	"逾1期余额",	"逾2期余额",	"逾3期余额",	"超3期余额",	"逾期租金金额",	"逾期金额%",	"逾1期金额",	"逾2期金额",	"逾3期金额",	"超3期金额"};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3014逾期超级管理", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T3Report/T3014Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3014逾期超级管理", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T3014");
//		return new ReplyAjaxPage(service.getTableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T3014逾期超级管理", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T3014");
//		
//		new POIExcelUtil().expExcel2007(m,"T3014逾期超级管理.xlsx", "T3014逾期超级管理", titleName , titleIndex, service.getTableDataForExp(m));
//
//		return null;
//	}
//
