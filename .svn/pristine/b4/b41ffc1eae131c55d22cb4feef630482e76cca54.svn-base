...
public class InsureBXBCPayAffirmService {
	
	private String basePath = "insurebxbczfAffirm.";
	
	public InsureBXBCPayAffirmService() {
	}
	...
	/**
	 *   核销一条保险补差支付申请状态 FIL_INSURE_APPLY_INFO
	 */
