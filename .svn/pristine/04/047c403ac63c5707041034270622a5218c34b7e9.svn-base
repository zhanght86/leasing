...
public class CreditAssetsDossierService {
	
	String basePath = "credit.AssetsDossier.";
	...
	public int updateOther(Map<String,Object> param){
	  ...
	  /**        ---------------------------------------------知识产权---------------------          **/
		...
		public Page getInterestListPage(Map<String,Object> map){
			Page page = new Page(map);
			page.addDate(JSONArray.fromObject(Dao.selectList(basePath+"getInterestListPage", map)), 10);
			return page;
		}

		public int doDeleteInterest(Map<String,Object> m) {
			return Dao.delete(basePath+"deleteInterest", m);
		}
		public int saveInterest(Map<String,Object> param){
			return Dao.insert(basePath+"saveInterest",param);
		}
		public int updatInterest(Map<String,Object> param){
			return Dao.update(basePath+"updateInterest",param);
		}
