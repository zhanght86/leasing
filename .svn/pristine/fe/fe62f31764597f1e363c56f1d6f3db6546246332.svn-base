...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T303供应商月份统计
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T303ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"区域",	"供应商",	"厂商",	"一月",	"二月",	"三月",	"四月",	"五月",	"六月",	"七月",	"八月",	"九月",	"十月",	"十一月",	"十二月",	"小计",	"百分比%"};
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T303供应商月份统计", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T3Report/T303Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T303供应商月份统计", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//
//		m.put("V_NAME", "V_REPORT_T303");
//		return new ReplyAjaxPage(service.getTableData(m));
//	}
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T303供应商月份统计", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		m.put("V_NAME", "V_REPORT_T303");
//		
//		new POIExcelUtil().expExcel2007(m,"T303供应商月份统计.xlsx", "T303供应商月份统计", titleName , titleIndex, service.getTableDataForExp(m));
//
//		return null;
//	}
//
