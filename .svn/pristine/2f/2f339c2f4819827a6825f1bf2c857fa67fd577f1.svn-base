...
function sureItem(){
	...
	urltemp = _basePath +'/insurebxbc/InsureBXBCPayDetail!doUpdateInsurChargeExhib.action?ID_DATA=' + ID_DATA + '&FK_AMT=' + FK_AMT + '&PROJ_AMT=' + PROJ_AMT + '&FACT_DATE=' + FACT_DATE;
