...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T106回款率统计
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T106ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"区域",	"供应商",	"厂商",	"个人客户",	"法人客户",	"在租项目",	"回购项目",	"提前还租项目",	"留购项目",	"剩余租金"};
//	private  String COLUMN_VIEW="COLUMN2,ID,COLUMN3";
//	private  String COLUMN_FORM="PARAM1,SUP_TYPE,COM_NAME";
//	private  String COLUMN_RELATION="LIKE,EQ,EQ";
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T106回款率统计", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T1Report/T106Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T106回款率统计", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T106回款率统计", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//		new POIExcelUtil().expExcel2007(m,"T106回款率统计.xlsx", "T106回款率统计", titleName , titleIndex, service.getTableExplorData(m));
//
//		return null;
//	}
//
