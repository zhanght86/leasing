$(function(){
	$("#table1").datagrid({
		url : 'LeaseVerify!getPageIdentityLP.action',
		columns : [[
			{field:'ID',checkbox:true,width:100},
			{field:'CUST_NAME',title:'公司名称',width:100},
			...
			{field:'REG_AMT',title:'注册资金万元',width:100},
			{field:'ISTRUE3',title:'是否正确',width:100},
			{field:'CUST_PEOPERTY',title:'公司属性',width:100},
			{field:'ISTRUE4',title:'是否正确',width:100},
			{field:'LEGAL_REPRESENT',title:'法人代表',width:100},
...
function exportExcel(flag){
	...
	//url
	var url = "LeaseVerify!exportExcelIdentityLp.action";
	if(flag == 'all')
	{
		url += "?exportAll=true";
	}else
