...
import com.pqsoft.base.sp.service.CreditDossierService;
...
public class CreditDossierAction extends Action {
	...
	String path = "base/sp/creditDossier/";

	@aPermission(name = { "合作机构", "SP管理", "查看", "信用档案" })
	...
	@aPermission(name = { "合作机构", "SP管理", "修改", "信用档案" })
	@aAuth(type = aAuthType.USER)
	@aDev(code = "170026", email = "whlpqsoft@163.com", name = "王海龙")
	...
	@aAuth(type = aAuth.aAuthType.LOGIN)
	@aPermission(name = { "合作机构", "SP管理", "修改", "银行征信" })
	@aDev(code = "wanghailong", email = "whlpqsoft@163.com", name = "王海龙")
