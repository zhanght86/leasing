...
///**
// * <p>
// * Title: 融资租赁信息系统平台 数据统计  T1072DB累计逾期分析
// * </p>
// * <p>
// * Description: T1租金查询
// * </p>
...
// * @version 1.0
// */
//public class T1072ReportAction extends Action {
//	private ReportBaseService service = new ReportBaseService();
//	Map<String,Object> m = null;
//	
//	String[] titlesName = new String[]{"区域",	"供应商",	"供应商编号",	"厂商",	"项目数量",	"台量",	"累计逾期次数",	"累计逾期天数",	"逾期1-10天",	"逾期11-20天",	"逾期21-30天",	"逾期31-60天",	"逾期60天以上"};
//	private  String COLUMN_VIEW="COLUMN2,COLUMN4,SUP_ID,COLUMN4";
//	private  String COLUMN_FORM="PARAM1,PARAM2,SUP_TYPE,COM_NAME";
//	private  String COLUMN_RELATION="LIKE,LIKE,EQ,EQ";
//	
//	
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T1072DB累计逾期分析", "列表页面" })
...
//		
//		return new ReplyHtml(VM.html("T1Report/T1072Report.vm", context));
//	}
//	
//	
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T1072DB累计逾期分析", "列表数据" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//	@SuppressWarnings("unchecked")
//	@aAuth(type = aAuth.aAuthType.USER)
//	@aPermission(name = { "数据统计", "T1072DB累计逾期分析", "列表导出" })
//	@aDev(code = "170062", email = "wujd@pqsoft.cn", name = "吴剑东")
...
//		}
//		new POIExcelUtil().expExcel2007(m,"T1072DB累计逾期分析.xlsx", "T1072DB累计逾期分析", titleName , titleIndex, service.getTableExplorData(m));
//
//		return null;
//	}
//
