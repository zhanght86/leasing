 ...
 *
 */
public class YtjtgDecistion implements DecisionHandler{
	...
	public String decide(OpenExecution execution) {
		...
		if(map != null){
			if(map.get("FIRSTTRIAL_YTJTG") != null && !map.get("FIRSTTRIAL_YTJTG").equals("")){
				Map<String, Object> param1 = new HashMap<String, Object>();
				param1.put("CODE", map.get("FIRSTTRIAL_YTJTG"));
