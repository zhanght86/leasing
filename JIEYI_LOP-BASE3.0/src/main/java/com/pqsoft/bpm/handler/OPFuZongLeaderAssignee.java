...
public class OPFuZongLeaderAssignee implements AssignmentHandler {
	...
	public void assign(Assignable assignable, OpenExecution execution) throws Exception {
		...
		String op = null;
		List<String> list = Dao.selectList("bpm.handler.queryfuzongLeaderCode", JBPMID.split("\\.")[0]+"."+JBPMID.split("\\.")[1]);
		for (String str : list) {
