...
/**
 * 专决书流程
 * @author Donzell 2014-1-13
 */
public class DesifnedDecisionLeader implements DecisionHandler {
	...
	public String decide(OpenExecution arg0) {
		...
		Object obj = Dao.selectOne(namespace + "queryDESIFNEDRelLeaders", param);
		if(obj!=null){
