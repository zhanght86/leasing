 ...
 *
 */
public class RefuseDecistion implements DecisionHandler{
	...
	public String decide(OpenExecution execution) {
		...
		if(map1 != null){
			if(map1.get("FIRSTTRIAL_SPJL") != null || map1.get("FIRSTTRIAL_SPJL").equals("")){
				Map<String, Object> map2 = new HashMap<String, Object>();
				map2.put("CODE", map1.get("FIRSTTRIAL_SPJL"));
